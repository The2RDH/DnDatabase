...
use App\Repository\TerrenosRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: TerrenosRepository::class)]
class Terrenos
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: Lugares::class, mappedBy: 'terreno')]
    ...
    public function removeLugare(Lugares $lugare): static
    {
        if ($this->lugares->removeElement($lugare)) {
            ...
            if ($lugare->getTerreno() === $this) {
                $lugare->setTerreno(null);
            }
        }
